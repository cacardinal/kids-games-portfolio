...
// The `id` of each profile keys its localStorage save (kg.detective.v1.<id>), so keeping
...
export const DEFAULTS: ProfileDef[] = [
  { id: "p1", name: "Player One", initial: "P", color: "#5a8a9a" },
  { id: "p2", name: "Player Two", initial: "P", color: "#a05a8a" },
