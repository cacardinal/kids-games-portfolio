...
// The `id` of each profile keys its localStorage save (kg.world-explorer.v1.<id>), so
// keeping the same ids across the default/override boundary preserves existing saves.
...
export const DEFAULTS: ProfileDef[] = [
  { id: "p1", name: "Player One", initial: "P", tint: "#b5642f" },
  { id: "p2", name: "Player Two", initial: "P", tint: "#2f7d72" },
